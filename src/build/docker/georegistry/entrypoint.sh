...
CATALINA_OPTS="${CATALINA_OPTS} -Dorientdb.db.url=${ORIENTDB_HOST}"
...
CATALINA_OPTS="${CATALINA_OPTS} -Ddatabase.admin.username=${DATABASE_USERNAME}"
CATALINA_OPTS="${CATALINA_OPTS} -Ddatabase.admin.password=${DATABASE_PASSWORD}"
